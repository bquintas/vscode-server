##Credit to Sofian Hamiti https://gist.github.com/sofianhamiti
...
yum install -y https://github.com/coder/code-server/releases/download/v4.7.1/code-server-4.7.1-amd64.rpm
